        ...
        >
            <div className="container mx-auto px-6">
                <div className="flex items-center justify-between">
                    {/* Logo */}
                    <Link href="/" className="flex items-center gap-2 font-bold text-2xl text-primary-600 transition-transform hover:scale-105">
                        <LucideSparkles className="h-8 w-8 animate-pulse" />
